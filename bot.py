...
bot = commands.Bot(case_insensitive=True, command_prefix=commands.when_mentioned_or('a?'))
...
async def presence():
    ...
    while not bot.is_closed():
        ...
        await sleep(30)
        await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.listening, name=f"to {len(bot.users)} users | a?help"))
        await sleep(30)
